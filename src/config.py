...
HEADLESS = os.getenv("PJE_HEADLESS", "0") == "1"
WARMUP = os.getenv("PJE_WARMUP", "0") == "1"
IDLE_TIMEOUT_SECONDS = int(os.getenv("PJE_IDLE_TIMEOUT", "600"))
...
MANUAL_TOTP_TIMEOUT = int(os.getenv("PJE_MANUAL_TOTP_TIMEOUT", "180"))

MCP_HOST = os.getenv("MCP_HOST", "127.0.0.1")
MCP_PORT = int(os.getenv("MCP_PORT", "8000"))
MCP_JSON_RESPONSE = os.getenv("MCP_JSON_RESPONSE", "1") == "1"
MCP_MAX_REQUEST_BODY = int(os.getenv("MCP_MAX_REQUEST_BODY", str(2 * 1024 * 1024)))
